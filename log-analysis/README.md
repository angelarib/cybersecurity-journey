...
bem-sucedido, em um intervalo de 14 segundos o que é um padrão consistente
com erro humano (poucas tentativas, sucesso rápido), diferente
de um ataque de força bruta real, que gera dezenas de
...
(o número de tentativas do teste, 2, fica abaixo desse limiar e é
por isso que não se caracteriza um ataque, e sim uso legítimo com erro humano)
